...
public class JCaptchaEngine extends ListImageCaptchaEngine {
	...
	private static final String IMAGE_PATH = "./org/veight/captcha/";// 随机背景图片路径
	...
	protected void buildInitialFactories() {
		...
		//如果采用背景图片的话，在linux上的tomcat会有问题,到正式运行的时候需要换一下
		//BackgroundGenerator backgroundGenerator = new FileReaderRandomBackgroundGenerator(IMAGE_WIDTH, IMAGE_HEIGHT, IMAGE_PATH);
		//背景颜色随机生成
		BackgroundGenerator backgroundGenerator = new GradientBackgroundGenerator(IMAGE_WIDTH, IMAGE_HEIGHT, Color.black,Color.pink); 
